 ...
 *
 * We currently do not even attempt to split toDOMNode things.  When this
 *  inevitably causes a problem the options are either to a) wrap such streams
 *  in a synthetic toDOMNode implementation that walks the output of the
 *  sub toDOMNodes and slices them at runtime, b) just require use of an
 *  explicit brief tag in such cases, or c) try and cover most cases by
 *  having a second duck-typed method that lets us ask such nodes to help out.
 */
...
exports.commonMixin = {
   ...
   */
  get briefDocStream() {
    return briefizeDocStream(this.docStream);
  },
  /**
