...
wy.defineWidget({
  ...
  impl: {
    postInit: function() {
      var pvRep = promiseToProtoVisRep(this.obj.promise,
                                       !this.obj.showBoring);
 ...
 */
exports.visualizePromise = function(doc, promise, showBoring) {
  var bodyElem = doc.documentElement.children[1];
  var emitter = wy.wrapElement(bodyElem);
  var obj = {promise: promise, showBoring: showBoring};
  emitter.emit({type: "vis-pwomise-tree", obj: obj},
