...
PopupManager.prototype = {
  ...
  popupHTML: function(relNode, htmlString) {
    ...
    if (topSpace > bottomSpace) {
      top = bodyElem.scrollTop + bounds.top - this.padding -
      ...
      connectorElem.setAttribute("style",
        "left: " + connLeft + "px; " +
        "top: " + (bodyElem.scrollTop + bounds.top - this.padding) + "px;" +
        "height: " + this.padding + "px;"
      );
    }
    else {
      top = bodyElem.scrollTop + bounds.bottom + this.padding;
      popupElem.setAttribute("style",
        "top: " + top + "px;" +
        "left: " + popLeft + "px;"
      );
      connectorElem.setAttribute("style",
        "left: " + connLeft + "px; " +
        "top: " + (bodyElem.scrollTop + bounds.bottom) + "px;" +
        "height: " + this.padding + "px;"
      );
    }
  },
