 ...
 */
function ExampleSlice(ctx, exampleName, rootTokenValue, depth, expandMap) {
}
...
exports.narscribblusExecFuncs = {
  ...
  exSlice: function(name, svals, tvals, ctx) {
    ...
    var rootTokenVal = null, depth = 1, expandMap = {};
//    if (svals.length > 1)
//      rootTokenVal = coerceString
