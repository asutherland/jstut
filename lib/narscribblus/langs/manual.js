...
Title.prototype = {
  ...
  toDOMNode: function(doc, recursiveFab) {
    var node = doc.createElement("h1");
    recursiveFab(node, this.titleStream);
    return node;
  },
};
...
Preformatted.prototype = {
  ...
  toDOMNode: function(doc, recursiveFab) {
    ...
    recursiveFab(node, this.textStream);
    return node;
  },
};
...
HierSection.prototype = {
  htmlDontWrapInPara: true,
  toDOMNode: function(doc, recursiveFab) {
    var node = doc.createElement("h" + (this.depth + 2));
    recursiveFab(node, this.titleBits);
    return node;
  },
};
...
DocLink.prototype = {
  // XXX this needs to be accomplished as a wmsy widget...
  toDOMNode: function(doc, recursiveFab) {
