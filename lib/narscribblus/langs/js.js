...
require.def("narscribblus/langs/js",
  [
    "exports",
...
DocNode.prototype = {
  ...
  gimmeRetType: function() {
    return jsdoc.findChildByType(this.rawStream, typerep.RetValDescriptor);
  },
