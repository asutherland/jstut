...
/**
 * XXX if we start adding title nodes and such, we will need something fancier.
 */
function htmlDocify(strOrNodes, options) {
  var s = "<!DOCTYPE html>\n<html><head><title>Narscribblus</title></head><body>";
  s += htmlStreamify(strOrNodes, options);
  s += "</body></html>";
  return s;
}
