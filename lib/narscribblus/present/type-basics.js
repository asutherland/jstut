...
wy.defineWidget({
  ...
  structure: {
    ...
    expanded: wy.widget({type: "type", detail: "expanded"}),
  },
  ...
  events: {
    name: {
      command: function() {
        this.ui_state.expanded = !this.ui_state.expanded;
        this.expanded_set(this.ui_state.expanded ? this.resolvedType : null);
      }
    }
  },
  style: {
