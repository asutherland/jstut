...
wy.defineWidget({
  ...
  structure: {
    ungrouped: wy.vertList({type: "type", detail: "expanded"},
...
wy.defineWidget({
  ...
  structure: {
    name: wy.bind("name"),
    entries: wy.vertList({type: "type", detail: "expanded"},
...
wy.defineWidget({
  ...
  structure: {
    ...
    expanded: wy.widget({type: "type", detail: "expanded"}, "type"),
  },
});
