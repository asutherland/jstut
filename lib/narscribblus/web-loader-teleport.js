...
exports.main = function web_loader_teleport_main() {
  ...
  if ("doc" in engine.env) {
    ...
    pkginfo.loadData(docPath).then(exports.showDoc, explodeSadFace);
  }
  else if ("src" in engine.env) {
    var srcPath = engine.env.src;
    pkginfo.loadSource(srcPath).then(exports.showDoc, explodeSadFace);
  }
};
...
exports.showDoc = function showDoc(aDocPath, aContents) {
  ...
  loader.parseDocument(aContents, docPath, options, documentParsed);
};
