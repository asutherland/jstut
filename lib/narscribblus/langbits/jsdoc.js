...
TypeRef.prototype = {
  ...
  citeTypeHTML: function(options, expandedNearby) {
    if (!this._resolve())
      return this.s;
    return this.resolved.citeTypeHTML(options, expandedNearby);
  },
  briefTypeExpansionHTML: function(options) {
    if (!this._resolve())
      return this.s;
    return this.resolved.briefTypeExpansionHTML(options);
  },
  detailedTypeExpansionHTML: function(options) {
    if (!this._resolve())
      return "";
    return this.resolved.detailedTypeExpansionHTML(options);
  },
  ...
  toHTMLString: function(options) {
    ...
    return this.resolved.toHTMLString(options);
  }
};
...
OneOf.prototype = {
  isType: true,
  citeTypeHTML: function(options, expandedNearby) {
    throw new Error("OneOf should not be cited.");
  },
  briefTypeExpansionHTML: function(options) {
    var s = "";
    var kids = this.kids;
...
Param.prototype = {
  ...
  // this should only happen in raw block views...
  toHTMLString: function(options) {
    return this.detailedTypeExpansionHTML(options);
  },
};
