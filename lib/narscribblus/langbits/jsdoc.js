...
define("narscribblus/langbits/jsdoc",
  [
...
function chewType(typeThing, ctx) {
  ...
  if (typeof(typeThing) === "number")
    return new $typerep.Value(typeThing,
                              "Number",
...
exports.narscribblusExecFuncs = {
  ...
  listof: function(tagName, svals, tvals, ctx) {
    var name = coerceString(svals[0]);
    var type = chewType(svals.length >= 2 ? svals[1] : "Object", ctx);
  ...
  protocol: function(tagName, svals, tvals, ctx) {
    var name = coerceString(svals[0]);
    var type = (svals.length >= 2) ? chewType(svals[1]) : null;
