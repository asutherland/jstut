...
wy.defineWidget({
  ...
  focus: wy.focus.nestedItem.vertical("typeExpanded"),
  structure: {
    header: {
      toggler: {},
    ...
    docStream: wy.stream({ type: "stream" }, wy.NONE),
    typeExpanded: wy.widget({ type: "type", detail: "expanded"}, wy.NONE),
  },
  impl: {
    postInit: function() {
      this.isExpanded = false;
      this.toggler_element.setAttribute("expanded", this.isExpanded);
    },
    toggle:function() {
      this.isExpanded = !this.isExpanded;
      this.toggler_element.setAttribute("expanded", this.isExpanded);
      this.docStream_set(this.isExpanded ? this.obj.message.docStream : null);
      this.typeExpanded_set(this.isExpanded ? this.obj.message : null);
