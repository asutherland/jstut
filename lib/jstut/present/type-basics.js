  ...
  style: {
    ...
    nameAndTypeRow: {
      ...
      "[expandable]": {
        ...
        ":hover": {
          _: ".hoveredExpandable",
          name: "background-image: url(jstut/data/images/section_collapsed_hover.png);",
          "name[expanded=true]": "background-image: url(jstut/data/images/section_expanded_hover.png);",
        },
      },
    },
    name: {
      _: [
        ...
        "display: table-cell;",
        "vertical-align: top;",
        "background: url(jstut/data/images/section_collapsed.png) no-repeat 0% 0%;",
        "padding-left: 20px;",
      ],
      "[full=true]": [
        "background: url(jstut/data/images/section_full.png) no-repeat 0% 0%;",
        "cursor: default;",
     ],
     "[expanded=true]": [
        "background: url(jstut/data/images/section_expanded.png) no-repeat 0% 0%;",
     ],
    },
    typeAndDefault: "display: table-cell;",
    desc: [
      "display: block;",
      "margin-left: 2em;",
    ],
