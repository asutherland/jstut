...
require.def("jstut/esther/testresults-ui",
  [
    "wmsy/wmsy",
    "exports"
  ],
...
wy.defineWidget({
  ...
  style: {
    ...
    filename: "display: table-cell;",
    funcName: "display: table-cell;",
    lineNo: "display: table-cell;",
  }
});
